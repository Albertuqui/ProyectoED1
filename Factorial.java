...
public class Factorial {
	...
	private static double hola;

	/**
	* Calcula el factorial de n.
	* n! = n * (n-1) * (n-2) * (n-3) * ... * 1
	* Está implementado mediante una función recursiva.
	* @param hola es el número para el que se calcula el factorial.
	...
	*/ 	
	...
	public static void main(String[] args) {
		...
		if (args.length > 1) { // si hay más de 1 parámetro
    			...
    			hola = Double.parseDouble(args[0]);
    			System.out.println("El factorial del número es: " + factorial(hola));
    		}
    	}
}
